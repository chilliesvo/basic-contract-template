...
import {RoyaltyInput} from "./interfaces/INFTFactory.sol";
import "./libraries/Helper.sol";

contract Monkey721PublicMint is ERC721EnumerableUpgradeable, ERC2981Upgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        emit ContractDeployed(_contractUri, _name, _symbol, _defaultReceiverRoyalty, _defaultPercentageRoyalty);
    }
