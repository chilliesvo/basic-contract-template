...
import {RoyaltyInput, TokenInput} from "../interfaces/INFTFactory.sol";

contract Monkey1155 is ERC1155Upgradeable, ERC2981Upgradeable, OwnableUpgradeable {
    ...
    ) external exceededTotalSupply(_amounts.length) onlyOwnerOrController returns (uint256[] memory tokenIds) {
